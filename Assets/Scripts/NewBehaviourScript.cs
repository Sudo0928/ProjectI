...
public class ImageAnimation : MonoBehaviour
{
    ...
    public float rotationDuration = 1f;  // 2초 동안 2바퀴 회전
    ...
    public float returnDuration2 = 3f; // 원래 자리로 돌아가는 시간 (빠르게 설정)
    ...
    IEnumerator AnimateImageFromLeft()
    {
        ...
        while (elapsedTime < returnDuration2)
        {
            transform.position = Vector3.Lerp(targetPosition, rightMovePosition, elapsedTime / returnDuration2);
            elapsedTime += Time.deltaTime;
            yield return null;
        }
    ...
    IEnumerator AnimateImageFromRight()
    {
        ...
        while (elapsedTime < returnDuration2)
        {
            transform.position = Vector3.Lerp(targetPosition, leftMovePosition, elapsedTime / returnDuration2);
            elapsedTime += Time.deltaTime;
            yield return null;
        }
